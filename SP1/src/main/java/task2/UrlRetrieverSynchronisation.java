...
public class UrlRetrieverSynchronisation {
    ...
    public static void main(String[] args) throws MalformedURLException, InterruptedException, IllegalStateException, IOException {
        ...
        UrlRetriever t1 = new UrlRetriever(new URL("https://www.youtube.com/watch?v=vlSR8Wlmpac"));
        UrlRetriever t2 = new UrlRetriever(new URL("https://www.starbucks.com"));
        UrlRetriever t3 = new UrlRetriever(new URL("https://www.fcbarcelona.cat"));
         
        //synchronously - 5095 milliseconds
//        t1.run();
//        t2.run();
//        t3.run(); 
        //asynchronously - The execution took 2322 milliseconds 
