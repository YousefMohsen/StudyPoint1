...
import task2.FibonacciObserver;
import task2.GuiObserver;
...
public class ObservableFibonacciCalculator extends Thread {
    ...
    public static void main(String[] args) {
        ...
        FibonacciObserver obs = (data) -> System.out.println(data);
         
    ObservableFibonacciCalculator calc = new ObservableFibonacciCalculator(8);
